<template>
    <v-container grid-list-xl fluid>
        <v-layout row wrap class="layout_dashboard">
            ...
            <div v-for="(item, index) in chartList" :key="index" :style="{width:item.width+'%'}">
                <v-card>
                    ...
                    <v-card-text class="white">
                        <!-- 차트영역 start -->
                        <GaugeChart v-if="item.chartName === 'CPU'" :series="cpuList"></GaugeChart>
                        <ScatterChart v-if="item.chartName === 'XLOG'" :series="xlogList"></ScatterChart>
                        <LineChart v-if="item.chartName === 'TPS'" :series="tpsList"></LineChart>
                        <ScatterChart v-if="item.chartName === 'ERROR RATE'" :series="errorRateList"></ScatterChart>
                        <ScatterChart v-if="item.chartName === 'ACTIVE SERVICE'" :series="activeServiceList"></ScatterChart>
                        <!-- 차트영역 end -->
                    </v-card-text>
                </v-card>
            </div>
...
export default {
    ...
    data() {
        return {
            ...
            xlogList: [], //xlog데이터
            tpsList: [], //tps데이터
            errorRateList: [], //errorRate데이터
            activeServiceList: [] //activeService데이터
        }
    },
